    ...
    >
        ...
        {sidebarOpen ? (
          <>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              />
              <Box sx={{ fontWeight: 600, fontSize: 16, whiteSpace: "nowrap" }}>
                Trading Extension
              </Box>
            </Box>
      ...
      <List sx={{ flex: 1, pt: 2, overflowY: "auto" }}>
        <ListItem disablePadding>
          <ThemeSelector expanded={sidebarOpen} />
        </ListItem>
              ...
              >
                <ListItemIcon
                  sx={{
                    ...
                    color:
                      location.pathname === item.path ? "#0071e3" : "inherit",
                  }}
                >
                  {item.icon}
                </ListItemIcon>
      ...
      >
        {sidebarOpen && <Box sx={{ pb: 1 }}>© 2026 Trading Extension</Box>}
      </Box>
    </Box>
  );
};
